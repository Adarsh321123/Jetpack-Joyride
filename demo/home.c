 ...
 */
asset_t *create_background_from_info(home_state_t *home_state, background_info_t info) {
 ...
 */
void create_backgrounds(home_state_t *home_state) {
 ...
 */
asset_t *create_button_from_info(home_state_t *home_state, button_info_t info) {
 ...
 */
void create_buttons(home_state_t *home_state) {
